...
def images_problem(url_processed_folder):
    import joblib
    # url_processed_folder = 'processed_data/'
    
    url_filename_X = url_processed_folder + 'X.gz'
    with open(url_filename_X, 'rb') as handle:
    ...
    print ('Processed Data: y:', y.shape, ' A:', A.shape, ' X:', X.shape)
